...
//    NSLog(@"upload1: %@",self.path);
//    NSLog(@"upload2: %@",[self.path stringByDeletingLastPathComponent]);
//    NSLog(@"upload3: %@",self.listingRequest.path);
...
//            NSLog(@"here");
            if (self.bytesRemaining == 0 && self.complete == false) {
                ...
                NSLog(@"總大小 %li",self.bytesRemaining);
